...
const handleLogin = () => {
    ...
    const credentials = {
        ...
        locale: locale.value // Truyền locale hiện tại để backend set session
    };
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">{{ t('auth.welcome') }}</div>
                        <span class="text-muted-color font-medium">{{ t('auth.signInToContinue') }}</span>
                    </div>
                    ...
                    <form @submit.prevent="handleLogin">
                        ...
                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            <div class="flex items-center">
                                <Checkbox v-model="checked" id="rememberme1" binary class="mr-2" :disabled="processing"></Checkbox>
                        ...
                        <Button
                            type="submit"
                            :label="processing ? 'Đang đăng nhập...' : t('auth.signIn')"
                            class="w-full"
                            :loading="processing"
                            :disabled="processing"
                        />
