...
const handleForgotPassword = () => {
    ...
    AuthService.forgotPassword(email.value, {
        ...
        onError: (errors) => {
            console.error('Forgot password errors:', errors);
        },
        onSuccess: () => {
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">{{ t('auth.forgotPasswordTitle') }}</div>
                        <span class="text-muted-color font-medium">{{ t('auth.forgotPasswordSubtitle') }}</span>
                    </div>
                    ...
                    <form @submit.prevent="handleForgotPassword">
                        ...
                        <div class="flex flex-col gap-4">
                            <Button
                                type="submit"
                                :label="processing ? t('auth.sending') : t('auth.sendResetLink')"
                                class="w-full"
                                :loading="processing"
                                :disabled="processing"
                            />
