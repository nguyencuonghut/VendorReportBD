<template>
    <Head>
        <title>Tạo phiếu đề nghị mới</title>
    </Head>

    <div class="card">
        <h2 class="text-2xl font-bold mb-6">Tạo phiếu đề nghị mới</h2>

        <form @submit.prevent="saveReport" class="flex flex-col gap-6">
            <!-- Tiêu đề phiếu -->
            <div>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t">
                ...
                <Button label="Lưu nháp" icon="pi pi-save" type="submit" :loading="saving" />
            </div>
        </form>
    </div>
</template>
